...
def vector_assembler() -> VectorAssembler:
    features = ['age','sex_index','is_married','salary','successfully_credit_completed','credit_completed_amount','active_credits','active_credits_amount', 'credit_amount','active_credits_amount']
