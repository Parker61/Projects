...
def vector_assembler() -> VectorAssembler:
    features = ['age','sex_index','is_married','salary','successfully_credit_completed','credit_completed_amount','active_credits','active_credits_amount']
...
def build_evaluator() -> RegressionEvaluator:
    evaluator = RegressionEvaluator(predictionCol='prediction', labelCol='credit_amount', metricName="rmse")
    return evaluator
...
if __name__ == "__main__":
    spark = SparkSession.builder.appName('PySparkMLJob1').getOrCreate()
